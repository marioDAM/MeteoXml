...
import jdom.JDomControllerTemperatura;
...
public class TemperaturaService {
    ...
    public List<CalidadAireDatosMeteoMes> procesarArchivoTemperatura() {
        File file = new File(Settings.temperatura);
        List<CalidadAireDatosMeteoMes> mediciones = new ArrayList<>();
        ...
        if (file.exists()) {
            try {
                ...
                for (int i = 0; i < nList.getLength(); i++) {
                    CalidadAireDatosMeteoMes c = new CalidadAireDatosMeteoMes();
